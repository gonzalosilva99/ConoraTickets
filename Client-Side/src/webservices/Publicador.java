...
public interface Publicador {
     ...
     */
    @WebMethod
    @Action(input = "http://webservices/publicador/finalizarEspectaculoRequest", output = "http://webservices/publicador/finalizarEspectaculoResponse")
     ...
     * @param arg0
     * @return
     *     returns webservices.SetEspectaculoPersistencia
     */
    @WebMethod
    @WebResult(partName = "return")
    @Action(input = "http://webservices/publicador/listarEspectaculosFinalizadosRequest", output = "http://webservices/publicador/listarEspectaculosFinalizadosResponse")
    public SetEspectaculoPersistencia listarEspectaculosFinalizados(
        @WebParam(name = "arg0", partName = "arg0")
        String arg0);
