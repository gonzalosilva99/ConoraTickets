 ...
 * 
 */
@WebServiceClient(name = "publicadorService", targetNamespace = "http://webservices/", wsdlLocation = "http://localhost:9105/publicador?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:9105/publicador?wsdl");
