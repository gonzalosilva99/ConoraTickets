 ...
 *                             &lt;element name="value" type="{http://webservices/}usuario" minOccurs="0"/>
 *                           &lt;/sequence>
 *                         &lt;/restriction>
 *                       &lt;/complexContent>
 *                     &lt;/complexType>
...
public abstract class Usuario {
    ...
    protected Usuario.Seguidores seguidores;
    @XmlElement(required = true)
    protected Usuario.Siguiendo siguiendo;
    @XmlSchemaType(name = "dateTime")
     ...
     * @return
     *     possible object is
     *     {@link Usuario.Seguidores }
     *     
     */
    public Usuario.Seguidores getSeguidores() {
        return seguidores;
    }
     ...
     *     
     */
    public void setSeguidores(Usuario.Seguidores value) {
     ...
     * @return
     *     possible object is
     *     {@link Usuario.Siguiendo }
     *     
     */
    public Usuario.Siguiendo getSiguiendo() {
        return siguiendo;
    }
     ...
     *     
     */
    public void setSiguiendo(Usuario.Siguiendo value) {
    ...
    public static class Seguidores {
        ...
        protected List<Usuario.Seguidores.Entry> entry;
         ...
         * {@link Usuario.Seguidores.Entry }
         * 
         * 
         */
        public List<Usuario.Seguidores.Entry> getEntry() {
            if (entry == null) {
                entry = new ArrayList<Usuario.Seguidores.Entry>();
            }
            return this.entry;
        }
    ...
    public static class Siguiendo {

        protected List<Usuario.Siguiendo.Entry> entry;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link Usuario.Siguiendo.Entry }
         * 
         * 
         */
        public List<Usuario.Siguiendo.Entry> getEntry() {
            if (entry == null) {
                entry = new ArrayList<Usuario.Siguiendo.Entry>();
            }
            return this.entry;
        }
