			...
			public void actionPerformed(ActionEvent arg0) {
				if (!datosPruebaCargados) {
					...
					try {
						...
						cat.add("Solistas");
						iplataforma.altaEspectaculo("Twitter Live", "clauper", "Memphis Blues World",
								"Espectáculo promoviendo álbum Memphis Blues.", 1, 1000,
								"https://twitter.com/cyndilauper", 800, fechaAltaEspectaculo, 110,
								"EspectaculoEspectaculoMemphis Blues World.jpg", cat, "https://youtu.be/ivHp3_gYXIc",
								"Meet & greet (encuentro) virtual con la legendaria cantante e ícono delPop, que inspiró a tantas otras cantante femeninas como Madonna yLady Gaga (aunque ellas jamás lo admitirían).",
								2);
						...
						iplataforma.confirmarAltaFuncionEspectaculo("Instagram Live", "Los Village Volvieron",
								"Los Village Volvieron - 1", fechaInicioFuncion, artistas, fechaAltaFuncion, "");
						...
						fechaAltaFuncion = FormatoInicio.parse("2020-03-31 00:00:00");
						iplataforma.confirmarAltaFuncionEspectaculo("Instagram Live", "Los Village Volvieron",
								"Los Village Volvieron - 2", fechaInicioFuncion, artistas, fechaAltaFuncion, "");
						...
						fechaAltaFuncion = FormatoInicio.parse("2020-03-31 00:00:00");
						iplataforma.confirmarAltaFuncionEspectaculo("Instagram Live", "Los Village Volvieron",
								"Los Village Volvieron - 3", fechaInicioFuncion, artistas, fechaAltaFuncion, "");
						...
						iplataforma.confirmarAltaFuncionEspectaculo("Facebook Watch", "Global Spirit",
								"Global Spirit (I)", fechaInicioFuncion, artistas, fechaAltaFuncion, "");
						...
						fechaAltaFuncion = FormatoInicio.parse("2020-04-20 00:00:00");
						iplataforma.confirmarAltaFuncionEspectaculo("Facebook Watch", "Global Spirit",
								"Global Spirit (II)", fechaInicioFuncion, artistas, fechaAltaFuncion, "");
						...
						iplataforma.confirmarAltaFuncionEspectaculo("Facebook Watch", "Global Spirit",
								"Global Spirit (III)", fechaInicioFuncion, artistas, fechaAltaFuncion, "");
						...
						fechaAltaFuncion = FormatoInicio.parse("2020-05-30 00:00:00");
						iplataforma.confirmarAltaFuncionEspectaculo("Twitter Live", "Memphis Blues World",
								"Memphis Blues World - A", fechaInicioFuncion, artistas, fechaAltaFuncion, "");
						...
						fechaAltaFuncion = FormatoInicio.parse("2020-05-30 00:00:00");
						iplataforma.confirmarAltaFuncionEspectaculo("Twitter Live", "Memphis Blues World",
								"Memphis Blues World - B", fechaInicioFuncion, artistas, fechaAltaFuncion, "");
						...
						fechaAltaFuncion = FormatoInicio.parse("2020-05-30 00:00:00");
						iplataforma.confirmarAltaFuncionEspectaculo("Twitter Live", "Memphis Blues World",
								"Memphis Blues World - C", fechaInicioFuncion, artistas, fechaAltaFuncion, "");
						...
						iplataforma.confirmarAltaFuncionEspectaculo("Youtube", "Springsteen on Broadway",
								"Springsteen on Broadway - i", fechaInicioFuncion, artistas, fechaAltaFuncion, "");
						...
						fechaAltaFuncion = FormatoInicio.parse("2020-06-07 00:00:00");
						iplataforma.confirmarAltaFuncionEspectaculo("Youtube", "Springsteen on Broadway",
								"Springsteen on Broadway - ii", fechaInicioFuncion, artistas, fechaAltaFuncion, "");
						...
						fechaAltaFuncion = FormatoInicio.parse("2020-06-07 00:00:00");
						iplataforma.confirmarAltaFuncionEspectaculo("Youtube", "Springsteen on Broadway",
								"Springsteen on Broadway - iii", fechaInicioFuncion, artistas, fechaAltaFuncion, "");

						// F18
						artistas.clear();
						fechaInicioFuncion = FormatoInicio.parse("2020-11-15 21:00:00");
						fechaAltaFuncion = FormatoInicio.parse("2020-07-31 00:00:00");
						iplataforma.confirmarAltaFuncionEspectaculo("Twitter Live", "30 a\u00f1os", "30 a\u00f1os - 3",
								fechaInicioFuncion, artistas, fechaAltaFuncion, "");
						...
						fechaAltaFuncion = FormatoInicio.parse("2020-07-31 00:00:00");
						iplataforma.confirmarAltaFuncionEspectaculo("Twitter Live", "30 a\u00f1os", "30 a\u00f1os - 2",
								fechaInicioFuncion, artistas, fechaAltaFuncion, "");
						...
						fechaAltaFuncion = FormatoInicio.parse("2020-07-31 00:00:00");
						iplataforma.confirmarAltaFuncionEspectaculo("Twitter Live", "30 a\u00f1os", "30 a\u00f1os - 1",
								fechaInicioFuncion, artistas, fechaAltaFuncion, "");
						...
						iplataforma.confirmarAltaFuncionEspectaculo("Twitter Live", "Bien de Familia",
								"Bien de Familia - C", fechaInicioFuncion, artistas, fechaAltaFuncion, "");
						...
						fechaAltaFuncion = FormatoInicio.parse("2020-07-08 00:00:00");
						iplataforma.confirmarAltaFuncionEspectaculo("Twitter Live", "Bien de Familia",
								"Bien de Familia - B", fechaInicioFuncion, artistas, fechaAltaFuncion, "");
						...
						fechaAltaFuncion = FormatoInicio.parse("2020-07-08 00:00:00");
						iplataforma.confirmarAltaFuncionEspectaculo("Twitter Live", "Bien de Familia",
								"Bien de Familia - A", fechaInicioFuncion, artistas, fechaAltaFuncion, "");
						...
						iplataforma.confirmarAltaFuncionEspectaculo("Youtube", "Grandes Exitos 2020",
								"Grandes Exitos 2020 - Dia", fechaInicioFuncion, artistas, fechaAltaFuncion, "");
						...
						fechaAltaFuncion = FormatoInicio.parse("2020-11-25 00:00:00");
						iplataforma.confirmarAltaFuncionEspectaculo("Youtube", "Grandes Exitos 2020",
								"Grandes Exitos 2020 - Noche", fechaInicioFuncion, artistas, fechaAltaFuncion, "");

						// F21
						artistas.clear();
						fechaInicioFuncion = FormatoInicio.parse("2020-12-18 21:30:00");
						fechaAltaFuncion = FormatoInicio.parse("2020-11-24 00:00:00");
						iplataforma.confirmarAltaFuncionEspectaculo("Instagram Live", "Llega a Casa",
								"Llega a Casa - 1", fechaInicioFuncion, artistas, fechaAltaFuncion, "");
						...
						fechaAltaFuncion = FormatoInicio.parse("2020-11-24 00:00:00");
						iplataforma.confirmarAltaFuncionEspectaculo("Instagram Live", "Llega a Casa",
								"Llega a Casa - 2", fechaInicioFuncion, artistas, fechaAltaFuncion, "");
