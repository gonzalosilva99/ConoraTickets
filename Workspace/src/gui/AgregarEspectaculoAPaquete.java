	...
	IPlataforma plataformosa = fabricosa.getIPlataforma();
		...
		comboBoxPlataformas.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent arg0) {
				...
				String aaa = comboBoxPaquetes.getSelectedItem().toString();
				if (aaa != "") {
					comboBoxEspectaculos.removeAllItems();
					comboBoxEspectaculos.addItem("");
					
					IPlataforma plataformosa = fabricosa.getIPlataforma();
				String bbb = comboBoxPlataformas.getSelectedItem().toString();
				
				Set<DtEspectaculo> EspectaculosNoPaquete = plataformosa.listarEspectaculosEnPlataformaNoPaquete(aaa , bbb);
		...
		buttonAceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				String aaa = comboBoxPaquetes.getSelectedItem().toString();
				String bbb = comboBoxPlataformas.getSelectedItem().toString();
				String ccc = comboBoxEspectaculos.getSelectedItem().toString();
			if (aaa!="" && bbb!="" && ccc!="") {
				IPaquete pac = fabricosa.getIPaquete();
				pac.confirmarAgregarEspectaculoPaquete(aaa, bbb, ccc);
