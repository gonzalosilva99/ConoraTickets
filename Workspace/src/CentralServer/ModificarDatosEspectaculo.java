...
public class ModificarDatosEspectaculo extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ModificarDatosEspectaculo frame = new ModificarDatosEspectaculo();
	 ...
	 */
		...
		public ModificarDatosEspectaculo() {
